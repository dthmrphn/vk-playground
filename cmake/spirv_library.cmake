function(glsl2spirv glsl header namespace)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} ARGS
            ...
            "-P ${CMAKE_CURRENT_LIST_DIR}/cmake/spirv2hpp.cmake"
        DEPENDS ${spirv_full}
...
function(add_spirv_library name)
    ...
    foreach(source ${add_spirv_library_GLSL})
        ...
        set(header_dir "${CMAKE_CURRENT_BINARY_DIR}/${directory}")
        set(header "${header_dir}/${file_name}.hpp")
        string(REGEX REPLACE "\\." "_" namespace ${file_name})

        glsl2spirv(${source_full} ${header} ${namespace})
